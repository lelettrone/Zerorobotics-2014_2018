...
//////////////////////
void takeMirror(){
//    setMovementPosition(allItem[Color+7],0.10f,0.03f);//0.34 //0.06
        memcpy(whereToGo,allItem[Color+7],sizeof(float)*3);
    if(getDistance(myState,allItem[Color+7])<=0.05f){ //0.136 //con lo switch <=0.138f
...
/////////////////////////////////////////////
////                                     ////
////    Author: Riccio-Cesa-Maglio       ////
////    Last release: 27/09/2015 00.00   ////
////    Game: SpySPHERES 2D              ////
////    Team: ZRighi                     ////
////                                     ////
/////////////////////////////////////////////
...
void loop(){
    ...
    setMovementPosition(whereToGo,0.1f,0.04);
}
//End page main
